...
public class EventOrganizer {
    ...
    public void run() {
        ...
        while(true){
            ...
            if(contents[0].equals("PE")){
                if(contents.length == 1){
                    System.out.println("PRINTING BY DATE!!");
    ...
    private boolean isValidCommand(String str){
        if(str.equals("A") || str.equals("R") || str.equals("P") || str.equals("PE") || str.equals("PC") || str.equals("PD")){
            return true;
        }
        return false;
    }
    ...
    private String isValidEvent(String [] contents){
        ...
        if(!contents[2].toLowerCase().equals("morning") && !contents[2].toLowerCase().equals("afternoon") && !contents[2].toLowerCase().equals("evening")){
            return "Invalid time slot!";
        }

        String roomToLower = contents[3].toLowerCase();
        if(!roomToLower.equals("hll114") && !roomToLower.equals("arc103") && !roomToLower.equals("be_aud") && !roomToLower.equals("til232") && !roomToLower.equals("ab2225") && !roomToLower.equals("mu302")){
            return "Invalid location!";
        }

        String departmentToLower = contents[4].toLowerCase();
        if(!departmentToLower.equals("cs") && !departmentToLower.equals("ee") && !departmentToLower.equals("iti") && !departmentToLower.equals("math") && !departmentToLower.equals("bait")){
